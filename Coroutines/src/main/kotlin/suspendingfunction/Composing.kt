...
fun main() = runBlocking {
    ...
    // If we want to get our work done faster in which there are no dependcies so we can usem these function under coroutines.
    val timeUsingCoroutine = measureTimeMillis {
        val sumUsingCoroutine = async { add(5, 8) }    // We can't use launch here as fun add and sutract are returning values
